...
String randomBannerName = 'Menu Test ' + CustomKeywords.'keyword.RandomGenerator.randomString'(30)

HashMap<String, Object> Menu = new HashMap<String, Object>()
Menu.put('id', GlobalVariable.ApiID)
...
subMenu.put('id', GlobalVariable.ApiID)
...
response = CustomKeywords.'keyword.API.Post' ('api/Menu/', Menu)
WS.verifyResponseStatusCode(response, 2014)