...
response = CustomKeywords.'keyword.API.Post' ('api/ProjectResultTypes/', ProjectResultTypes)

WS.verifyElementPropertyValue(response, 'otherName', randomBannerName)
println (response)
