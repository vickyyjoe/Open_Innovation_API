...
String randomBannerName = 'Files Upload Multiple File To File System Test ' + CustomKeywords.'keyword.RandomGenerator.randomString'(30)
...
response = CustomKeywords.'keyword.API.Post' ('/api/Files/UploadMultipleFileToFileSystem', Files)
