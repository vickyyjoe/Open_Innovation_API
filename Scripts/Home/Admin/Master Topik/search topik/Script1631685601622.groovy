...
WebUI.setText(findTestObject('Admin/Master TOpik/search topik/input_searchTopik'), 'Tech')

//WebUI.sendKeys(findTestObject(‘Object location’), )
WebUI.sendKeys(findTestObject('Admin/Master TOpik/search topik/input_searchTopik'), Keys.chord(Keys.ENTER))

WebUI.verifyElementText(findTestObject('Admin/Master TOpik/search topik/td_Technology'), 'Technology')
