...
WebUI.click(findTestObject('Admin/Idea Verif/Revise/button_Revise'))

WebUI.setText(findTestObject('Admin/Idea Verif/Accept/textarea_acceptNote'), 'revise ')
...
WebUI.verifyElementText(findTestObject('Admin/Idea Verif/Revise/span_Revise'), 'Revise')
