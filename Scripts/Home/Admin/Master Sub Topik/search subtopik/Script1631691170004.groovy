...
WebUI.setText(findTestObject('Admin/Master Sub Topik/input_searchSubtopik'), 'fin')

WebUI.sendKeys(findTestObject('Admin/Master Sub Topik/input_searchSubtopik'), Keys.chord(Keys.ENTER))

WebUI.verifyElementText(findTestObject('Admin/Master Sub Topik/td_FinTech'), 'FinTech')
