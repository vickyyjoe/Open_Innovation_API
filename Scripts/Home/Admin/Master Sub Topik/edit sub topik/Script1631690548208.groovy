...
WebUI.click(findTestObject('Admin/Master Sub Topik/edit/button_actionSubTopik'))

WebUI.click(findTestObject('Admin/Master Sub Topik/edit/button_Edit'))

WebUI.click(findTestObject('Admin/Master Sub Topik/edit/select_TopikEdit'))

WebUI.setText(findTestObject('Admin/Master Sub Topik/edit/input_Sub TopikEdit'), 'FinTech')

WebUI.click(findTestObject('Admin/Master Sub Topik/edit/select_Status'))
...
WebUI.verifyElementText(findTestObject('Admin/Master Sub Topik/td_Culinary'), 'FinTech')
