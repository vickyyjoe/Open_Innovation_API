...
String randomBannerName = 'Topiks PUT Test ' + CustomKeywords.'keyword.RandomGenerator.randomString'(30)
String randomBanner = 'PUT Test ' + CustomKeywords.'keyword.RandomGenerator.randomString'(30)

HashMap<String, Object> Topiks = new HashMap<String, Object>()

Topiks.put('id', GlobalVariable.ApiID)
